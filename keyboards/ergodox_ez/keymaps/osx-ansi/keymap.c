...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_ESC,KC_NO,     KC_NO,  KC_LALT,KC_LGUI,
                                              KC_BSPACE,  KC_LGUI,
                                                              KC_DEL,
                                              KC_SPC,LT(SYMB,KC_GRV),KC_END,
        // right hand
             KC_RGHT,     KC_6,   KC_7,  KC_8,   KC_9,   KC_0,             KC_NO,
             KC_NO,    KC_Y,   KC_U,  KC_I,   KC_O,   KC_P,             KC_MINS,
                          KC_H,   KC_J,  KC_K,   KC_L,   KC_SCLN,          RCTL_T(KC_RBRC),
             KC_NO,KC_N,   KC_M,  KC_COMM,KC_DOT, KC_SLSH,          RSFT_T(KC_QUOT),
                                  KC_RGUI,KC_BSLS,KC_NO,KC_NO,        KC_ESC,
             KC_LALT,        CTL_T(KC_ESC),
             KC_PGUP,
             KC_PGDN,LT(SYMB,KC_EQL), KC_ENT
    ),
